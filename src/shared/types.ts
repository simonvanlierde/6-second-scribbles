...
export type GameMessage =
  ...
  | { type: 'drawpad_restore'; playerId: string; strokes: DrawStroke[] }
  | { type: 'idle_prompt'; timeoutMs: number }
  | { type: 'idle_confirm'; playerId: string }
  | { type: 'idle_confirmed' }
...
// Add messages for erase/restore scaffolding
export type DrawpadRestore = { type: 'drawpad_restore'; playerId: string; strokes: DrawStroke[] }
