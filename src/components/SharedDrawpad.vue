<template>
  <div class="shared-drawpad">
    <div class="canvas-tools">
      ...
      <div class="tool-group">
        <button class="btn btn-small" @click="clearLocal">Clear</button>
      </div>
    </div>
...
function clearLocal() {
  canvas.clear()
  // Local clear should be sent by host via higher-level control; keep local clear for personal use
}
